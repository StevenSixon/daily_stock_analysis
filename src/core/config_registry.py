...
WEB_SETTINGS_HIDDEN_FROM_UI = {
    "DATABASE_PATH",
    # PEI is a host-side Worker integration, not a DSA Web runtime setting.
    "RESEARCH_ENABLED",
    "RESEARCH_CODEX_HOME",
    "RESEARCH_PEI_PLUGIN_SKILL",
    "RESEARCH_PEI_PLUGIN_VERSION",
    "RESEARCH_PEI_WORKFLOW_VERSION",
    "RESEARCH_MCP_SERVER_NAME",
    "RESEARCH_MCP_SERVER_VERSION",
    "RESEARCH_CODEX_MODEL",
    "RESEARCH_CODEX_PROFILE",
    "RESEARCH_CODEX_TIMEOUT_SECONDS",
    "RESEARCH_ARTIFACTS_DIR",
    "RESEARCH_CODEX_BINARY",
    "RESEARCH_CODEX_FORWARD_ENV",
    "RESEARCH_DATABASE_PATH",
    "RESEARCH_EVIDENCE_PACKS_DIR",
    "RESEARCH_DOCUMENTS_DIR",
    "RESEARCH_SQLITE_BUSY_TIMEOUT_MS",
    "RESEARCH_WORKER_API_URL",
    "RESEARCH_WORKER_TOKEN",
    "RESEARCH_WORKER_SCOPES",
    "RESEARCH_WORKER_ID",
    "RESEARCH_WORKER_LEASE_SECONDS",
    "RESEARCH_WORKER_POLL_SECONDS",
    "RESEARCH_JOB_MAX_RETRIES",
    "RESEARCH_RUN_TOKEN_BUDGET",
    "RESEARCH_MONTHLY_TOKEN_BUDGET",
    "RESEARCH_MCP_ALLOWED_TOOLS",
    "RESEARCH_MCP_HTTP_TIMEOUT_SECONDS",
    "RESEARCH_MCP_MAX_RESPONSE_BYTES",
    "RESEARCH_CNINFO_QUERY_URL",
    "RESEARCH_CNINFO_STOCK_LIST_URL",
    "RESEARCH_DISCLOSURE_ALLOWED_HOSTS",
    "RESEARCH_AUTO_TRIGGER_DISCLOSURES",
    "RESEARCH_AUTO_TRIGGER_ALERTS",
    "RESEARCH_NOTIFY_ON_PUBLISH",
    "RESEARCH_DISCLOSURE_SCAN_INTERVAL_MINUTES",
    "RESEARCH_DISCLOSURE_SCAN_LOOKBACK_DAYS",
    "RESEARCH_DISCLOSURE_MAX_PAGES",
    "SQLITE_WAL_ENABLED",
